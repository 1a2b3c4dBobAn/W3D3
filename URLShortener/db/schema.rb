...
ActiveRecord::Schema.define(version: 20180503000852) do
  ...
  create_table "tag_topics", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tag"], name: "index_tag_topics_on_tag", unique: true
  end
  ...
  create_table "taggings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tag_topic_id"], name: "index_taggings_on_tag_topic_id", unique: true
